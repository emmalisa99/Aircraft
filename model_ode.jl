...
function f(X,Ut,t=0)  
    ...
    v_body = inv(P_I2B) * X[4:6] # Peut faire uniquement la transposé car changement de base entre repères orthonormés 
    ...
    Xp[4:6] =  Fa/X[11] - physical_data.g  + U[1]/X[11] * i# (aircraft.kt*X[4:6] + i) 
